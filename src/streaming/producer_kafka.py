...
def kafka_producer_loop(csv_path, kafka_bootstrap, topic, rate=5.0, max_rows=None, repeat=False):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--repeat", action="store_true", help="loop dataset indefinitely")
    args = parser.parse_args()
    kafka_producer_loop(args.csv, args.kafka, args.topic, args.rate, args.max_rows, args.repeat)
